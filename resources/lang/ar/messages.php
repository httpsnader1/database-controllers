...
return [
    ...
    'structure_and_data' => 'الهيكل والبيانات',
    'export_format' => 'تنسيق التصدير',
    'sql_format' => 'ملف SQL (.sql)',
    'zip_format' => 'أرشيف ZIP (.zip)',
    'import_zip_sql' => 'حدد ملف .sql أو .zip لاستعادة قاعدة البيانات الخاصة بك.',
    'no_sql_in_zip' => 'لم يتم العثور على ملف SQL في أرشيف ZIP.',
    'zip_open_failed' => 'فشل فتح أرشيف ZIP.',
    'zip_create_failed' => 'فشل إنشاء أرشيف ZIP.',
    'no_backups_found' => 'لا يوجد نسخ احتياطية',
    'no_backups_found_desc' => 'قم بإنشاء نسخة احتياطية لأول مرة بالنقر فوق الزر العلوي.',
