...
return [
    ...
    'structure_and_data' => 'Structure et données',
    'export_format' => 'Format d\'exportation',
    'sql_format' => 'Fichier SQL (.sql)',
    'zip_format' => 'Archive ZIP (.zip)',
    'import_zip_sql' => 'Sélectionnez un fichier .sql ou .zip pour restaurer votre base de données.',
    'no_sql_in_zip' => 'Aucun fichier SQL trouvé dans l\'archive ZIP.',
    'zip_open_failed' => 'Échec de l\'ouverture de l\'archive ZIP.',
    'zip_create_failed' => 'Échec de la création de l\'archive ZIP.',
    'no_backups_found' => 'Aucune sauvegarde trouvée',
    'no_backups_found_desc' => 'Générez votre première sauvegarde en cliquant sur le bouton en haut.',
